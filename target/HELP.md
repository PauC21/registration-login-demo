...
* The original package name 'net.guides.springboot.registration-login-demo' is invalid and this project uses 'net.guides.springboot.registration_login_demo' instead.
